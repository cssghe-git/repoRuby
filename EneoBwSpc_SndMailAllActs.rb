...
=begin
    ...
    Call:       ruby EneoBwSpc_SndMailAllActs.rb --exec=B/P --debug=INFO
=end
...
DRY_RUN         = true
ATTACH_DIR      = "/users/Gilbert/Public/MemberLists/ToSend"
...
#==========
    ...
    loop do
        ...
        (data["results"] || []).each do |page|
            ...
            # load attachment
            attachment = find_single_attachment_optional(ref)
